...
//
//        processesCounter = new DataIndexCounter(ALL_PROCESS_INSTANCES_IDS_QUERY, PROCESS_INSTANCES, dataIndexWebClient);
//
//        Multi<String> processesMulti = Multi.createFrom().emitter(multiEmitter -> {
//            multiEmitter.emit("new value");
//        });
//
