...
import { init, KogitoEditorEnvelopeApiImpl } from "@kie-tools-core/editor/dist/envelope";
...
const initEnvelope = () => {
  ...
  EditorEnvelope.initCustom({
    ...
    apiImplFactory: {
      create: (args) => new KogitoEditorEnvelopeApiImpl(args, new ServerlessWorkflowCombinedEditorFactory()),
    },
    keyboardShortcutsService: new NoOpKeyboardShortcutsService(),
  });
};
