...
function log(msg: string, args: any = "") {
  console.log("##############################################################################");
  console.log(`StandaloneServerlessWorkflowCombinedEditorChannelApi ${msg}`, args);
  console.log("##############################################################################");
}
  ...
  implements ServerlessWorkflowCombinedEditorChannelApi
{
  ...
  public async kogitoSwfLanguageService__getCompletionItems(args: {
    ...
    log("standalone-getCompletionItems", this.swfLanguageServiceChannelApiImpl);
    ...
    return new Promise<CompletionItem[]>(async (resolve, reject) => {
      try {
        ...
        log("standalone-getCompletionItems result", result);
        resolve(result);
      } catch (err) {
        log("standalone-getCompletionItems error", err);
        reject(err);
      }
    });
  }
