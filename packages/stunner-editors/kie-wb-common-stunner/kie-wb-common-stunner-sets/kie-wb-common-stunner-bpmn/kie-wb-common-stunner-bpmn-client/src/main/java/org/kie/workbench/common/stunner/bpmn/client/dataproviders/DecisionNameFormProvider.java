...
public class DecisionNameFormProvider implements SelectorDataProvider {
    ...
    @Inject
    private FileNameFormProvider fileNameFormProvider;
    ...
    public SelectorData<String> getSelectorData(final FormRenderingContext context) {
        ...
        if (fileNameFormProvider != null && fileNameFormProvider.getDecisionName() != null) {
            for (String value : fileNameFormProvider.getDecisionName())
